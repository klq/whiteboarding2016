...
Text taken from Wikipdia pages 
[Major-General's Song](http://en.wikipedia.org/wiki/Major-General%27s_Song) and 
[Gödel, Escher, Bach](http://en.wikipedia.org/wiki/G%C3%B6del,_Escher,_Bach), 
with some characters converted to ASCII for convenience.
'''
